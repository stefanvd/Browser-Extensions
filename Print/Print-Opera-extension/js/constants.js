...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('print-opera-install-button')) {
		$('print-opera-install-button').style.display = 'none';
		$('print-opera-thanks-button').style.display = '';
	}
}
...
var writereview = "https://addons.opera.com/en/extensions/details/print/";
var linkchangelog = "https://www.stefanvd.net/project/print/browser/opera/changelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkwelcomepage = "https://www.stefanvd.net/project/print/browser/opera/welcome.htm";
var linkuninstall = "https://www.stefanvd.net/";
var fullscreenwebsite = "https://www.stefanvd.net/project/print/browser/";