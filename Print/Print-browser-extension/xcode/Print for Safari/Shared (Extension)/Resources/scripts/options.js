...
var youtubeembed = "https://www.stefanvd.net/browser/extension/embed/?vid=PLfXHh3TKRb4bgUqxW-1xFCCB_3mAK5Otk";
var darkmode = false;
...
function domcontentloaded(){
	...
	$("o1").addEventListener("click", function(){ document.images["preview"].src = "/images/reel19@2x.png"; });
	$("o2").addEventListener("click", function(){ document.images["preview"].src = "/images/windows19@2x.png"; });
	$("o3").addEventListener("click", function(){ document.images["preview"].src = "/images/windows19-dark@2x.png"; });
	$("p1").addEventListener("click", function(){ document.images["preview"].src = "/images/default@2x.png"; });
	$("p2").addEventListener("click", function(){ document.images["preview"].src = "/images/gray19@2x.png"; });
	$("p3").addEventListener("click", function(){ document.images["preview"].src = "/images/whitegray19@2x.png"; });
	$("p4").addEventListener("click", function(){ document.images["preview"].src = "/images/white19@2x.png"; });
	$("p5").addEventListener("click", function(){ document.images["preview"].src = "/images/wood19@2x.png"; });
	$("p6").addEventListener("click", function(){ document.images["preview"].src = "/images/gold19@2x.png"; });
	$("p7").addEventListener("click", function(){ document.images["preview"].src = "/images/darkgreen19@2x.png"; });
	$("p8").addEventListener("click", function(){ document.images["preview"].src = "/images/green19@2x.png"; });
	$("p9").addEventListener("click", function(){ document.images["preview"].src = "/images/pink19@2x.png"; });
	$("p10").addEventListener("click", function(){ document.images["preview"].src = "/images/red19@2x.png"; });
	$("d1").addEventListener("click", function(){ document.images["preview"].src = "/images/printmaterialdesign@2x.png"; });
	$("d2").addEventListener("click", function(){ document.images["preview"].src = "/images/printmaterialdesign-dark@2x.png"; });
	$("a1").addEventListener("click", function(){ document.images["preview"].src = "/images/feet19@2x.png"; });
