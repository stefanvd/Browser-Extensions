...
struct Page1: View{
    ...
    var body: some View{
        VStack{
            ...
            Text("Let us walk you through the awesome Print Safari extension features.")
              .multilineTextAlignment(.center)
              .opacity(animate ? 1 : 0)
              .offset(y: animate ? 0 : 20)
              .animation(
        ...
        ScrollView{
            VStack{
                ...
                VStack(alignment: .leading){
                    ...
                    Text("I take your privacy and security very seriously. I built the Print browser extension with my users in mind first, to ensure a great web experience for everyone. When you add Print, the browser states that it can \"Read and change all your data on the websites you visit\". This permission is required only so that Print can print the current web page. I have never collected, and will never collect, any personal data, credit card information, browsing history, or passwords.\n\nFurthermore, the Print browser extension is free and Open-Source with the source code publicly available on GitHub.")
                     
                    Link(destination: URL(string: "https://github.com/stefanvd/Browser-Extensions/tree/master/Print/Print-browser-extension")!) {
                        Text("https://github.com/stefanvd/Browser-Extensions/tree/master/Print/Print-browser-extension")
        ...
        ScrollView{
            VStack{
                ...
                VStack(alignment: .leading){
                    ...
                    Text("When you double-tap the Print button, a small panel appears showing the actions you can take. These include printing in color, printing in black and white, saving the current web page, and opening the Options page.")
...
//                        .accessibilityHint(Text("Opens in your web browser"))
                    ...
                    Text("On the Print Options page, you can customize your printing experience and access the option to view the context menu.")
