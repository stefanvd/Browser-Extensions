...
struct EnableView: View {
    private let extensionBundleIdentifier = "com.stefanvd.print-for-safari.extension"
        ...
        .toolbar {
            ...
            ToolbarItemGroup(placement: .primaryAction) {
                ShareLink("",
                          ...
                          subject: Text("FREE Print Safari extension"),
                          message: Text("Download the free Print Safari extension to print the current web page in color or black and white. Try it yourself! via @Stefanvd  \(StefanLinks().linkdeveloperwebsite())"))
            }
        }
        .formStyle(.grouped)
        .navigationTitle("")
