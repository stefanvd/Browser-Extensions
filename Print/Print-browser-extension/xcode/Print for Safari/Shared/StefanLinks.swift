...
class StefanLinks {
    ...
    func linkredirectionoptions() -> String{
        return "https://www.stefanvd.net/project/print/browser/options/"
    }
    ...
    func linksourcecode() -> String{
        return "https://github.com/stefanvd/Browser-Extensions/tree/master/Print/Print-browser-extension"
    }
