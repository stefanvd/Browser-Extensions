...
function checkdarkmode(){
    chrome.storage.sync.get(['darkmode'], function(items){
        ...
        if(darkmode == true){
            ...
            $('headlamp').src = "icons/default@2x.png";
            $('headlamp').srcset = "icons/default.png 1x, icons/default@2x.png 2x";
            $('headlamp').style.webkitFilter = "invert(1) grayscale(1)";
            $('headlamp').style.filter = "invert(1) grayscale(1)";
        } else{
            $('currentdarkmode').innerText = chrome.i18n.getMessage("titledarkmodeoff");
            document.body.className = 'light';
            $('headlamp').src = "icons/default@2x.png";
            $('headlamp').srcset = "icons/default.png 1x, icons/default@2x.png 2x";
            $('headlamp').style.webkitFilter = "invert(0) grayscale(0)";
            $('headlamp').style.filter = "invert(0) grayscale(0)";
        }
    });
}
...
if(window.location.href != exoptionspage){
    ...
    if(condition == "online"){
        ...
        $("dont-turn-off-the-lights").src = "https://www.youtube.com/embed/?listType=playlist&amp;list=PLfXHh3TKRb4bgUqxW-1xFCCB_3mAK5Otk";
        read_options();
        yearnow();
        });
    }else{
