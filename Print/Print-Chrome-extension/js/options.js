...
function save_options(){
  chrome.storage.sync.set({ "icon": $("btnpreview").src,"optionskipremember": $('optionskipremember').checked});
}
...
chrome.storage.sync.get(['icon','countremember','optionskipremember'], function(items){
