...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('print-edge-install-button')) {
		$('print-edge-install-button').style.display = 'none';
		$('print-edge-thanks-button').style.display = 'block';
	}
}
...
var printproduct = "https://chrome.google.com/webstore/detail/print-for-google-chrome/idfnpgjblkahngbondojabhffkkdekbd"
...
var writereview = "https://chrome.google.com/webstore/detail/print/idfnpgjblkahngbondojabhffkkdekbd/reviews";
var linkchangelog = "https://www.stefanvd.net/project/print/browser/edge/changelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkwelcomepage = "https://www.stefanvd.net/project/print/browser/edge/welcome.htm";
var linkuninstall = "https://www.stefanvd.net/project/print/browser/edge/uninstall.htm";
