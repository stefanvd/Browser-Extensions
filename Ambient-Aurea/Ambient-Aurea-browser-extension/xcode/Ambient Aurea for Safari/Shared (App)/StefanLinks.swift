...
class StefanLinks {
    ...
    func linkredirectionoptions() -> String{
        return "https://www.stefanvd.net/project/ambient-aurea/browser/options/"
    }
    ...
    func linksourcecode() -> String{
        return "https://github.com/stefanvd/Browser-Extensions/tree/master/Ambient-Aurea/Ambient-Aurea-browser-extension"
    }
