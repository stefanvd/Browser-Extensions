...
struct EnableView: View {
    private let extensionBundleIdentifier = "com.stefanvd.Ambient-Aurea-for-Safari.extension"
        ...
        .toolbar {
            ...
            ToolbarItemGroup(placement: .primaryAction) {
                ShareLink("",
                          ...
                          subject: Text("FREE Ambient Aurea Safari extension"),
                          message: Text("Download the free Ambient Aurea Safari extension to view your images of that web page in a gallery. Try it yourself! via @Stefanvd  \(StefanLinks().linkdeveloperwebsite())"))
            }
        }
        .formStyle(.grouped)
        .navigationTitle("")
