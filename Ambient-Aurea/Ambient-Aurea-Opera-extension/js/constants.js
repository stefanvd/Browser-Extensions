...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('ambient-aurea-opera-install-button')) {
		$('ambient-aurea-opera-install-button').style.display = 'none';
		$('ambient-aurea-opera-thanks-button').style.display = '';
	}
}
...
var writereview = "https://addons.opera.com/extensions/details/ambient-aurea/";
var linkchangelog = "https://www.stefanvd.net/project/ambient-aurea/browser/opera/changelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkguide = "https://www.stefanvd.net/project/ambient-aurea/browser/opera/guide.htm";
var linkwelcomepage = "https://www.stefanvd.net/project/ambient-aurea/browser/opera/welcome.htm";
var linkuninstall = "https://www.stefanvd.net/project/ambient-aurea/browser/opera/uninstall.htm";
