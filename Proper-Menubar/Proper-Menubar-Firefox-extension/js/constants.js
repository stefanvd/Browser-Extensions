...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('proper-menubar-firefox-install-button')) {
		$('proper-menubar-firefox-install-button').style.display = 'none';
		$('proper-menubar-firefox-thanks-button').style.display = 'block';
	}
}
...
var writereview = "https://addons.mozilla.org/firefox/addon/proper-menubar/reviews";
var linkchangelog = "https://www.stefanvd.net/project/proper-menubar/browser/firefox/changelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkguide = "https://www.stefanvd.net/project/proper-menubar/browser/firefox/guide.htm";
var linkwelcomepage = "https://www.stefanvd.net/project/proper-menubar/browser/firefox/welcome.htm";
var linkuninstall = "https://www.stefanvd.net/project/proper-menubar/browser/firefox/uninstall.htm";
var propermenubarwebsite = "https://www.stefanvd.net/project/proper-menubar/browser/";
var browsernewtab = "about:blank";
...
var newdownloads = "about:downloads";
var newextensions = "about:addons";
var newpolicy = "about:policies";
var newinspect = "about:devtools";
var newflags = "about:config";
var newabout = "about:support";
var newbookmarks = "https://getpocket.com/a/queue";
var newhistory =  "https://myactivity.google.com/myactivity";
var newsettings = "about:preferences";
