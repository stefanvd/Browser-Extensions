...
var youtubeembed = "https://www.stefanvd.net/browser/extension/embed/?vid=PLfXHh3TKRb4ZIWFeG31L_jRs5fRHtzYAc";
var darkmode = false;
...
function domcontentloaded(){
	...
	$("p0").addEventListener("click", function(){
		var custombrowser = "";
		if(exbrowser == "safari"){ custombrowser = "/images/icon38safari.png"; }else{ custombrowser = "/images/icon38safari.png"; }
		setpreviewicon(custombrowser);
	});
	$("p1").addEventListener("click", function(){
		var custombrowser = "";
		if(exbrowser == "safari"){ custombrowser = "/images/icon38whitesafari.png"; }else{ custombrowser = "/images/icon38whitesafari.png"; }
		setpreviewicon(custombrowser);
	});
