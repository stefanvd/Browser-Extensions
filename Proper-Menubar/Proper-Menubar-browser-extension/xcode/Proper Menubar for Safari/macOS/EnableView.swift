...
struct EnableView: View {
    private let extensionBundleIdentifier = "com.stefanvd.propermenubarsafari.extension"
        ...
        .toolbar {
            ...
            ToolbarItemGroup(placement: .primaryAction) {
                ShareLink("",
                          ...
                          subject: Text("FREE Proper Menubar Safari extension"),
                          message: Text("Download the free Proper Menubar Safari extension to restore the classic menu bar (File, Edit, View) at the top. Try it yourself! via @Stefanvd  \(StefanLinks().linkdeveloperwebsite())"))
            }
        }
        .formStyle(.grouped)
        .navigationTitle("")
