...
chrome.runtime.onMessage.addListener(function(msg, sender, sendResponse){
    ...
    perm.forEach(function(x){
        if($("permissionlist")){
            ...
            else if(x == "pageCapture"){textperm = chrome.i18n.getMessage("permissionpagecapture");}
            else if(x == "clipboardWrite"){textperm = chrome.i18n.getMessage("permissionclipwrite");}
            else if(x == "clipboardRead"){textperm = chrome.i18n.getMessage("permissionclipread");}
            else if(x == "bookmarks"){textperm = chrome.i18n.getMessage("permissionbookmarks");}
