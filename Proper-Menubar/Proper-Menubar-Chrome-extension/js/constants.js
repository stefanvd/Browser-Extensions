...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('proper-menubar-chrome-install-button')) {
		...
		$('proper-menubar-chrome-thanks-button').style.display = '';
	}
}
...
var linkchangelog = "https://www.stefanvd.net/project/propermenubarchromechangelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkguide = "https://www.stefanvd.net/project/propermenubarchromeguide.htm";
var linkwelcomepage = "https://www.stefanvd.net/project/propermenubarchrome.htm";
