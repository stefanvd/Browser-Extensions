...
struct Page1: View{
    ...
    var body: some View{
        VStack{
            ...
            Text("Let us walk you through the awesome Font Size Increase Safari extension features.")
              .multilineTextAlignment(.center)
              .opacity(animate ? 1 : 0)
              .offset(y: animate ? 0 : 20)
              .animation(
        ...
        ScrollView{
            VStack{
                ...
                VStack(alignment: .leading){
                    ...
                    Text("I take your privacy and security very seriously. I built the Font Size Increase browser extension with my users in mind first, to ensure a great web experience for everyone. When you add Font Size Increase, the browser states that it can \"Read and change all your data on the websites you visit\". This permission is required only so that Font Size Increase can be adjust the font size on the current web page. I have never collected, and will never collect, any personal data, credit card information, browsing history, or passwords.\n\nFurthermore, the Font Size Increase browser extension is free and Open-Source with the source code publicly available on GitHub.")
                     
                    Link(destination: URL(string: "https://github.com/stefanvd/Browser-Extensions/tree/master/Font-Size-Increase/Font-Size-Increase-browser-extension")!) {
                        Text("https://github.com/stefanvd/Browser-Extensions/tree/master/Font-Size-Increase/Font-Size-Increase-browser-extension")
        ...
        ScrollView{
            VStack{
                ...
                VStack(alignment: .leading){
                    ...
                    Text("When you tap the A+ icon, the font size on the current web page increases. Double-tapping the A+ icon resets the font size to its default setting.")
...
//                        .accessibilityHint(Text("Opens in your web browser"))
                    ...
                    HStack(spacing: 20) {
                        Image(systemName: "5.circle.fill")
                            ...
                            .frame(width: 35, height: 35)
                            .accessibilityHidden(true)
                        Text("Enable **\"Font Size Increase\"**")
                    }
