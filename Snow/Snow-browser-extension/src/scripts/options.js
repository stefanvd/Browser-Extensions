...
var youtubeembed = "https://www.youtube.com/embed/?listType=playlist&amp;list=PLfXHh3TKRb4bt1rKyK15B_pHrnKDd9Ai6";
var darkmode = false;
...
function save_options(){
	...
	var snowShape = document.getElementById("snowShape");

	chrome.storage.sync.set({"icon": $("btnpreview").src, "optionskipremember": $("optionskipremember").checked, "contextmenus": $("contextmenus").checked, "snowAmount": $("snowAmount").value, "snowColor": $("snowColor").value, "colorOption": colorOption.options[colorOption.selectedIndex].value, "snowShape": snowShape.options[snowShape.selectedIndex].value, "snowSize": $("snowSize").value, "snowSpeed": $("snowSpeed").value, "windDirectionControl": $("windDirectionControl").checked, "snowOnBottom": $("snowOnBottom").checked});
}
...
function read_options(){
	...
	chrome.storage.sync.get(["firstDate", "icon", "countremember", "optionskipremember", "contextmenus", "firstsawrate", "snowAmount", "snowColor", "colorOption", "snowShape", "snowSize", "snowSpeed", "windDirectionControl", "snowOnBottom"], function(items){
		...
		if(items["snowAmount"]){ $("snowAmount").value = items["snowAmount"]; }
		if(items["snowColor"]){ $("snowColor").value = items["snowColor"]; }
		if(items["colorOption"]){ $("colorOption").value = items["colorOption"]; }
		if(items["snowShape"]){ $("snowShape").value = items["snowShape"]; }
		if(items["snowSize"]){ $("snowSize").value = items["snowSize"]; }
		if(items["snowSpeed"]){ $("snowSpeed").value = items["snowSpeed"]; }
		if(items["windDirectionControl"] == true){ $("windDirectionControl").checked = true; }
		if(items["snowOnBottom"] == true){ $("snowOnBottom").checked = true; }
...
function domcontentloaded(){
	...
	$("p0").addEventListener("click", function(){ document.images["preview"].src = "/images/iconblack19@2x.png"; });
	$("p1").addEventListener("click", function(){ document.images["preview"].src = "/images/iconblue19@2x.png"; });
	$("p2").addEventListener("click", function(){ document.images["preview"].src = "/images/iconwhite19@2x.png"; });
	$("p3").addEventListener("click", function(){ document.images["preview"].src = "/images/iconred19@2x.png"; });
	$("p4").addEventListener("click", function(){ document.images["preview"].src = "/images/iconyellow19@2x.png"; });
	$("p5").addEventListener("click", function(){ document.images["preview"].src = "/images/icongreen19@2x.png"; });
	...
	// Save KB download
	$("tabbasic").addEventListener("click", function(){ Scrolltotop(); OFFworkaroundbugfromsafari(); $("welcomeguide").src = ""; memguide(); guidekb = true; mobilecheck(); });
	$("tabadvan").addEventListener("click", function(){ Scrolltotop(); ONworkaroundbugpreview(); $("dont-turn-off-the-lights").src = ""; $("managed-prefs-banner").style.display = ""; $("welcomeguide").src = ""; memguide(); guidekb = true; mobilecheck(); });
	...
	$("tabhelp").addEventListener("click", function(){ Scrolltotop(); ONworkaroundbugpreview(); $("dont-turn-off-the-lights").src = ""; $("managed-prefs-banner").style.display = ""; $("welcomeguide").src = ""; memguide(); guidekb = true; mobilecheck(); });
