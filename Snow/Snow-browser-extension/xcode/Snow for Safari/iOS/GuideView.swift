...
struct Page1: View{
    ...
    var body: some View{
        VStack{
            ...
            Text("Let us walk you through the awesome Snow Safari extension features.")
              .multilineTextAlignment(.center)
              .opacity(animate ? 1 : 0)
              .offset(y: animate ? 0 : 20)
              .animation(
        ...
        ScrollView{
            VStack{
                ...
                VStack(alignment: .leading){
                    ...
                    Text("I take your privacy and security very seriously. I built the Snow browser extension with my users in mind first, to ensure a great web experience for everyone. When you add Snow, the browser states that it can \"Read and change all your data on the websites you visit\". This permission is required only so that Snow can be added to the current web page. I have never collected, and will never collect, any personal data, credit card information, browsing history, or passwords.\n\nFurthermore, the Snow browser extension is free and Open-Source with the source code publicly available on GitHub.")
                     
                    Link(destination: URL(string: "https://github.com/stefanvd/Browser-Extensions/tree/master/Snow/Snow-browser-extension")!) {
                        Text("https://github.com/stefanvd/Browser-Extensions/tree/master/Snow/Snow-browser-extension")
        ...
        ScrollView{
            VStack{
                ...
                VStack(alignment: .leading){
                    ...
                    Text("When you tap the Snow icon, a quick menu appears where you can choose the amount of snow falling on the current web page, as well as the snow type, color, wind direction, and whether the snow should melt at the bottom of the page.")
                ...
                VStack(alignment: .leading){
                    HStack{
                        VStack(alignment: .leading, spacing: 10){
                            Text("Settings")
                                .font(.subheadline)
                            Text("Choose your Button Action")
                                .font(.headline)
                                .fontWeight(.bold)
                                .overlay(
                                    Rectangle()
...
//                        .accessibilityHint(Text("Opens in your web browser"))
                    ...
                    Text("On the Snow Options page, you can customize the winter snow experience to suit your preferred style.")
        ...
        ScrollView{
            VStack{
                ...
                VStack(alignment: .leading){
                    ...
                    Text("Built with performance in mind, this extension runs quietly in the background. It does not slow down your browser or clutter your screen. Simple, effective, and designed to just work exactly when you need it.")
