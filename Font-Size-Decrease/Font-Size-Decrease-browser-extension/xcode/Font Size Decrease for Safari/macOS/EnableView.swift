...
struct EnableView: View {
    private let extensionBundleIdentifier = "com.stefanvd.fontsizedecreasesafari.extension"
        ...
        .toolbar {
            ...
            ToolbarItemGroup(placement: .primaryAction) {
                ShareLink("",
                          ...
                          subject: Text("FREE Font Size Increase Safari extension"),
                          message: Text("Download the free Font Size Increase Safari extension to adjust your text size in any web page. Try it yourself! via @Stefanvd  \(StefanLinks().linkdeveloperwebsite())"))
            }
        }
        .formStyle(.grouped)
        .navigationTitle("")
