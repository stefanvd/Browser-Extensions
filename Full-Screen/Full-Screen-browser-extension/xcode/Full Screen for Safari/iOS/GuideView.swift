...
struct Page1: View{
    ...
    var body: some View{
        VStack{
            ...
            Text("Let us walk you through the awesome Full Screen Safari extension features.")
              .multilineTextAlignment(.center)
              .opacity(animate ? 1 : 0)
              .offset(y: animate ? 0 : 20)
              .animation(
            ...
            VStack{
                ...
                VStack(alignment: .leading){
                    VStack(alignment: .leading, spacing: 10){
                        Text("Button")
                            .font(.subheadline)
                        Text("Double-tap for a Quick Menu")
                            .font(.headline)
                            .fontWeight(.bold)
                            .overlay(
                                Rectangle()
...
//                        .accessibilityHint(Text("Opens in your web browser"))
                    ...
                    Text("On the Full Screen Options page, you can choose what action occurs when you tap this button, as well as how large the popup window should be.")
