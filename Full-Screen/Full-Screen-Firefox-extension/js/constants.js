...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('full-screen-firefox-install-button')) {
		$('full-screen-firefox-install-button').style.display = 'none';
		$('full-screen-firefox-thanks-button').style.display = '';
	}
}
...
var writereview = "https://addons.mozilla.org/firefox/addon/full-screen-for-firefox/reviews/";
var linkchangelog = "https://www.stefanvd.net/project/full-screen/browser/firefox/changelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkguide = "https://www.stefanvd.net/project/full-screen/browser/firefox/guide.htm";
var linkwelcomepage = "https://www.stefanvd.net/project/full-screen/browser/firefox/welcome.htm";
var linkuninstall = "https://www.stefanvd.net/project/full-screen/browser/firefox/uninstall.htm";
var zoomwebsite = "https://www.stefanvd.net/project/full-screen/browser/";