...
chrome.storage.local.get(['contextmenus','fullscreenweb','fullscreenwindow','fullscreenvideo'], function(items){
...
// Reset settings
$("resetfullscreen").addEventListener('click', function() {chrome.storage.local.clear();location.reload();});
