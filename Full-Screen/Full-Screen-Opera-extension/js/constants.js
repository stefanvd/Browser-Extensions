...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('full-screen-chrome-install-button')) {
		...
		$('full-screen-chrome-thanks-button').style.display = '';
	}
}
...
var linkchangelog = "https://www.stefanvd.net/project/fullscreenchromechangelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkguide = "https://www.stefanvd.net/project/fullscreenchromeguide.htm";
var linkwelcomepage = "https://www.stefanvd.net/project/fullscreenchrome.htm";
