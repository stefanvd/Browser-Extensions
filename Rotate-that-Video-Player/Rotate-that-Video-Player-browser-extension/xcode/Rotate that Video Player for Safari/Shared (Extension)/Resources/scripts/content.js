...
if(window.location.href.match(/^http(s)?:\/\/(www\.)?stefanvd.net/i)){
	if($("rotate-that-video-player-" + exbrowser + "-install-button")){
		$("rotate-that-video-player-" + exbrowser + "-install-button").style.display = "none";
		$("rotate-that-video-player-" + exbrowser + "-thanks-button").style.display = "block";
	}
}
