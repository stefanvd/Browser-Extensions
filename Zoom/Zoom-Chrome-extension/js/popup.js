...
chrome.tabs.query({windowId: chrome.windows.WINDOW_ID_CURRENT, active: true}, function(tabs) {zoomtab(tabs[0].id,currentRatio);});
}
...
function zoomtab(a,b){
    ...
    if (zoomchrome == true) {
        ...
        try{chrome.tabs.executeScript(null,{code:"document.body.style.zoom=" + b});}
        catch(e){}
    }
