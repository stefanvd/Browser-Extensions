...
class AboutController: UITableViewController{
    ...
    func openweb() {
        if let url = URL(string: "https://www.stefanvd.net") {
            UIApplication.shared.open(url)
        }
    }
    func opensupport() {
        if let url = URL(string: "https://www.stefanvd.net/support/") {
            UIApplication.shared.open(url)
        }
    }

    var productURL = URL(string: "https://itunes.apple.com/app/id1585512140")!
    func openreview() {
...
//        #endif
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
            activityVC.popoverPresentationController?.sourceView = cellshare
        }
    ...
    @IBAction func opentranslate(_ sender: Any) {
        ...
        if let url = URL(string: "https://www.stefanvd.net/project/translate/") {
            UIApplication.shared.open(url)
        }
    }
