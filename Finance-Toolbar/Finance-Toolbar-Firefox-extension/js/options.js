...
// Reset settings
$("resetfinancetoolbar").addEventListener('click', function() {chrome.storage.local.clear();location.reload();});
...
$("apgetapp").addEventListener('click', function() {window.open(financetoolbarapp, "_blank");$("sectionfinancetoolbarappbox").style.display = "none";chrome.storage.local.set({"applastonversion": chrome.runtime.getManifest().version});});
$("apnt").addEventListener('click', function() {$("sectionfinancetoolbarappbox").style.display = "none";chrome.storage.local.set({"applastonversion": chrome.runtime.getManifest().version});});
