...
chrome.storage.local.get(['twelfh','badge','lightcolor','clockbck','colorhours','colorminutes','clockanalog','clocktickpoint','colorbackground','colordots'], function(response){
...
chrome.storage.local.get(['stamp'], function(items){
...
if ((chromeset["firstRun"]!="false") && (chromeset["firstRun"]!=false)){
  ...
  chrome.storage.local.set({"version": "1.1"});
}
});