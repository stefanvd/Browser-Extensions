...
struct EnableView: View {
    private let extensionBundleIdentifier = "com.stefanvd.datetodaysafari.extension"
        ...
        .toolbar {
            ...
            ToolbarItemGroup(placement: .primaryAction) {
                ShareLink("",
                          ...
                          subject: Text("FREE Date Today Safari extension"),
                          message: Text("Download the free Date Today Safari extension to view the current date and time. Try it yourself! via @Stefanvd  \(StefanLinks().linkdeveloperwebsite())"))
            }
        }
        .formStyle(.grouped)
        .navigationTitle("")
