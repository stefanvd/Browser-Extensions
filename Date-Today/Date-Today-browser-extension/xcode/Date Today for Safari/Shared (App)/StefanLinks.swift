...
class StefanLinks {
    ...
    func linkredirectionoptions() -> String{
        return "https://www.stefanvd.net/project/date-today/browser/options/"
    }
    ...
    func linksourcecode() -> String{
        return "https://github.com/stefanvd/Browser-Extensions/tree/master/Date-Today/Date-Today-browser-extension"
    }
