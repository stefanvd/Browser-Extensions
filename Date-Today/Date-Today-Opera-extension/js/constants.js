...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('date-today-opera-install-button')) {
		$('date-today-opera-install-button').style.display = 'none';
		$('date-today-opera-thanks-button').style.display = '';
	}
}
...
var writereview = "https://addons.opera.com/extensions/details/date-today/";
var linkchangelog = "https://stefanvd.net/project/date-today/browser/opera/changelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkguide = "https://stefanvd.net/project/date-today/browser/opera/guide.htm";
var linkwelcomepage = "https://stefanvd.net/project/date-today/browser/opera/welcome.htm";
var linkuninstall = "https://stefanvd.net/project/date-today/browser/opera/uninstall.htm";
