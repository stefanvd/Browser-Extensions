...
chrome.storage.sync.get(['color1','color2','color3','color4','color5','color6','twelfh','begintime','endtime','nightmode','color1night','color2night','color3night','color4night','color5night','color6night'], function(response){
color1 = response.color1;if(!color1)color1 = 'Gray';
color2 = response.color2;if(!color2)color2 = 'Black';
color3 = response.color3;if(!color3)color3 = 'Gray';
color4 = response.color4;if(!color4)color4 = 'Black';
color5 = response.color5;if(!color5)color5 = 'Black';
color6 = response.color6;if(!color6)color6 = 'Black';
twelfh = response.twelfh;
begintime = response.begintime;if(!begintime)begintime = "21:00";
endtime = response.endtime;if(!endtime)endtime = "23:45";
nightmode = response.nightmode;
color1night = response.color1night;if(!color1night)color1night = '#0fff58';
color2night = response.color2night;if(!color2night)color2night = '#0fff58';
color3night = response.color3night;if(!color3night)color3night = '#0fff58';
color4night = response.color4night;if(!color4night)color4night = '#0fff58';
color5night = response.color5night;if(!color5night)color5night = '#0fff58';
color6night = response.color6night;if(!color6night)color6night = '#0fff58';
        ...
        document.body.appendChild(daynumber);
        }
