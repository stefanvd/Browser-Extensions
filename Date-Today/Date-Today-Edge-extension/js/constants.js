...
if (window.location.href.match(/http:\/\/(.*stefanvd\.net\/.*|www\.stefanvd\.net\/.*\/.*)/i)){
	if ($('date-today-edge-install-button')) {
		$('date-today-edge-install-button').style.display = 'none';
		$('date-today-edge-thanks-button').style.display = 'block';
	}
}
...
var linkchangelog = "https://www.stefanvd.net/project/date-today/browser/edge/changelog.htm";
var linktranslate = "https://www.stefanvd.net/project/translate.htm";
var linksupport = "https://www.stefanvd.net/support/";
var linkguide = "https://www.stefanvd.net/project/date-today/browser/edge/guide.htm";
var linkwelcomepage = "https://www.stefanvd.net/project/date-today/browser/edge/welcome.htm";
var linkuninstall = "https://www.stefanvd.net/project/date-today/browser/edge/uninstall.htm";
